...
def assert_response_status(
    response: requests.Response, expected_status: int, message: str = None
) -> None:
    """
...
def assert_field_value(
    data: dict, field: str, expected_value: Any, message: str = None
) -> None:
    """
...
def assert_field_exists(data: dict, field: str, message: str = None) -> None:
    """
...
def assert_field_type(
    data: dict, field: str, expected_type: type, message: str = None
) -> None:
    """
...
def assert_list_not_empty(data: List, message: str = None) -> None:
    """
...
def assert_json_response(response: requests.Response, message: str = None) -> Dict:
    """
...
def assert_response_time(
    response: requests.Response, max_time_ms: int, message: str = None
) -> None:
    """
...
def assert_status_in_list(
    response: requests.Response, valid_statuses: List[int], message: str = None
) -> None:
    """
