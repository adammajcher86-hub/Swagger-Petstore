...
import random
from config.test_data import PET_CATEGORIES
...
class TestDataFactory:
    ...
    @staticmethod
    def create_pet(
        status: str = "available", pet_id: int = None, name: str = None
    ) -> Dict[str, Any]:
        """
        Generate pet data.
    ...
    @staticmethod
    def create_order(
        pet_id: int, quantity: int = 1, order_id: int = None, status: str = "placed"
    ) -> Dict[str, Any]:
        """
        Generate order data.
    ...
    @staticmethod
    def create_user(username: str = None, user_id: int = None) -> Dict[str, Any]:
        """
        Generate user data.
    ...
    def create_multiple_pets(
        count: int, status: str = "available"
    ) -> List[Dict[str, Any]]:
        """
